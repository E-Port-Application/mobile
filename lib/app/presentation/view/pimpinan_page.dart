...
class PimpinanPage extends GetView<PimpinanController> {
        ...
        () => Column(
          children: [
            LaporanFilter(
              ...
              value: LaporanController.i.selectedPimpinan.value,
              onReset: controller.onReset,
              onActivity: controller.onActivity,
              data: controller.datas,
              filterDate: [
                LaporanController.i.startDatePimpinan.value,
                LaporanController.i.endDatePimpinan.value,
              ],
