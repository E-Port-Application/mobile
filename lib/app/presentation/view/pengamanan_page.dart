...
class PengamananPage extends GetView<PengamananController> {
  final bool isPamwal;
  final LaporanType type;
  const PengamananPage({
    super.key,
    this.isPamwal = false,
    required this.type,
  });
  ...
  Widget build(BuildContext context) {
    return LaporanScaffold.detail(
      title:
          "${isPamwal ? "Pamwal" : "Pengamanan"} / ${LaporanController.i.title(type)} Kegiatan",
      child: Form(
          ...
          () => Column(
            children: [
              ...
              InputPersonil(
                ...
                id: "pengamanan",
                docId: "pengamanan/${controller.data.value?.id}",
                type: type,
              ),
              SizedBox(height: 12.h),
              AppInput(
