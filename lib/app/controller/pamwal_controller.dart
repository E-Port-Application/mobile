...
import 'package:eport/app/repository/pamwal_repository.dart';
...
class PamwalController extends GetxController {
  static PamwalController get i => Get.find<PamwalController>();
  ...
  Rxn<PamwalModel> data = Rxn<PamwalModel>(null);
  ...
  void onInit() {
    super.onInit();
    if (Get.currentRoute.contains("/laporan/kegiatan/pamwal")) {
      type.value = LaporanType.update;
    } else if (Get.currentRoute.contains("/laporan/riwayat/pamwal")) {
